...
It allows users to upload spatial transcriptomics data, visualize predicted protein landscapes, and perform analyses such as differential expression, co-expression, spatial mapping, and drug-target exploration.
DGATviz bridges transcriptomic and proteomic information to reveal cellular states, immune phenotypes, and spatial organization within tissues."
